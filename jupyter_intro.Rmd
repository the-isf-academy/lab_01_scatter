...
Make sure you include `%autosave 0` in the first cell of all your notebooks. Juypter has an autosaving feature, but we will use manual saves to make sure we always have synced `.ipynb` and `.Rmb` files.
